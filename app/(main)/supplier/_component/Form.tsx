            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="field">
                    ...
                    <Controller
                        ...
                        render={({ field }) => <InputText id="supplierName" {...field} className={classNames({ 'p-invalid': errors.supplierName })} />}
                    />
                    {getFormErrorMessage('supplierName')}
                </div>
                <div className="field">
                    <label htmlFor="phone">Phone</label>
                    <Controller name="phone" control={control} rules={{ required: 'Phone is required.' }} render={({ field }) => <InputText id="phone" {...field} className={classNames({ 'p-invalid': errors.phone })} />} />
